...
#define MyAppExeName "XRF_Report_Auto_Input_v1.0.9.exe"
#define MySetupBaseName "XRF_Report_Auto_Input_Setup_v1.0.9"
...
[Files]
Source: "C:\Users\USER\Desktop\program\dist\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
